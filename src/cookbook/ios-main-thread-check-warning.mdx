...
This option can be switched off in the respective run scheme diagnostic options, see "_Detect Improper UI Updates on Background Threads_" section of the ["_Diagnosing Memory, Thread, and Crash Issues Early_."](https://developer.apple.com/documentation/xcode/diagnosing_memory_thread_and_crash_issues_early)
