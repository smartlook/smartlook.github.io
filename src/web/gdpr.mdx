...
<TextBlock kind="important">
	{`
  This API is for projects created before **6th of February 2022**.
  \n\n
  API for projects created after **6th of February 2022** can be found at <a href="https://docs.smartlook.com/docs/web/consent-sensitive-data" target="_blank" rel="noopener noreferrer">Consent sensitive data</a>.
`}
</TextBlock>
