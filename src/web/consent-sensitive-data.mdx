...
<TextBlock kind="important">
  ...
  It is enabled by default in projects created after the 1st of April 2022 (consent version 2).
  ...
  There is an ongoing transition period until the 1st of June 2022 in which you should migrate to the new API.
