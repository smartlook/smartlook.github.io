...
Webhooks are sent from anomalies. Anomalies are described on our updates page <a href="https://updates.smartlook.com/worried-about-anomalies-in-your-events-190172" target="_blank">HERE</a>
...
<h3> 3. Catch HTTP requests </h3>



<h3> 4. Verify the message </h3>

You can verify the message about HASH. More info [HERE](#security)
