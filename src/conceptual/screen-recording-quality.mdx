...
<Link to="/conceptual/handling-sensitive-data#recording-modes-handling-sensitive-data-at-the-whole-screen-level">Recording Modes: Handling Sensitive Data at the Whole Screen Level</Link>.
