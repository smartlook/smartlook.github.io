...
<TextBlock>{`
Read more about rendering modes in the <Link to="/conceptual/handling-sensitive-data#recording-modes-handling-sensitive-data-at-the-whole-screen-level">Rendering Modes: Handling Sensitive Data at the Whole Screen Level</Link>.
`}</TextBlock>
