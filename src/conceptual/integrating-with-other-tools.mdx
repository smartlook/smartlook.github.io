...
<Link to="/docs/sdk/api-reference#dashboard-session-url">Session URL API Reference</Link>.
...
<Link to="/docs/sdk/api-reference#dashboard-visitor-url">Visitor URL API Reference</Link>.
