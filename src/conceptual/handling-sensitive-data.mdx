...
Smartlook.setSensitivity(SmartlookSensitivity.EXPLICITLY_SENSITIVE, portraitImageView);
`,
      kotlin: `
val portraitImageView = findViewById(R.id.portrait_image_view) as ImageView
portraitImageView.isSensitive = SmartlookSensitivity.EXPLICITLY_SENSITIVE
`
    },
      ios: {
      swift: `
...
Smartlook.setSensitivity(SmartlookSensitivity.EXPLICITLY_INSENSITIVE, portraitImageView);
`,
      kotlin: `
val webView = findViewById(R.id.web_view) as WebView
webView.isSensitive = SmartlookSensitivity.EXPLICITLY_INSENSITIVE
`
    },
      ios: {
      swift: `
...
<CodeBlock kind="example"
    snippets={{
      android: {
      java: `
Smartlook.setSensitivity(SmartlookSensitivity.EXPLICITLY_SENSITIVE, WebView.class);
`,
      kotlin: `
WebView::class.java.isSensitive = SmartlookSensitivity.EXPLICITLY_SENSITIVE
`
    },
      ios: {
      swift: `
