...
Not available on this platform.
    ...
    ios: {
      swift: `
Smartlook.setup(key:"API_KEY", options:[.enableCrashytics: true])
      `,
      'objective-c': `
[Smartlook startWithKey:@"API_KEY" withOptions:@{ SLSetupOptionEnableCrashyticsKey:@YES } ];
      `,
    },
    flutter: {
      dart: `
...
Then in Crashlytics dashboard, there should be a new `Smartlook session URL` key-value pair with link to your Smartlook dashboard.
Once opened, you can directly play recording just before the crash.
