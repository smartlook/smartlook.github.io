...
import { CodeBlock, TextBlock, Alert } from "components";
...
<Alert kind="info" visibleOn="android">info here</Alert>
<Alert kind="important" visibleOn="android">important here</Alert>
<Alert kind="warning" visibleOn="android">warning here</Alert>
