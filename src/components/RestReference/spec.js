	...
	paths: {
		...
		'/api/v1/events/{eventId}': {
			get: {
				...
				operationId: 'getEventDetail1',
			},
		},
		'/api/events/{eventId}/visitors': {
			get: {
				responses: {
					'200': {
						description: 'Success',
		...
		'/api/v1/visitors/{visitorId}': {
			get: {
				...
				operationId: 'getVisitorDetails1',
			},
		},
		'/api/visitors/{visitorId}/sessions': {
			get: {
				responses: {
					'200': {
						description: 'Success',
		...
		'/api/v1/visitors/{visitorId}/sessions': {
			get: {
				...
				operationId: 'getVisitorSessions1',
			},
		},
