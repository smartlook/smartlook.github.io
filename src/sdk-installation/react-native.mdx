...
Smartlook native library is installed as a **Cocoapods dependency**. There are no manual steps required, just make sure your Cocoapod dependecies are up-to-date after Smartlook RN installation dependecy.
...
React Native version 0.60+ on iOS 10+ and Android FIXME. 
