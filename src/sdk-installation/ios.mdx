...
Smartlook can also be added directly to the app project by **downloading** our latest [Smartlook iOS SDK (1.8.4)](https://sdk.smartlook.com/ios/smartlook-ios-sdk-1.8.4.52.zip), unzipping the file, and adding `Smartlook.xcframework` to the Xcode project.
