...
There are three ways how to integrate Smartlook into your app:
...
Smartlook can be also added directly to the app project by **downloading** our latest [Smartlook iOS SDK (1.7.1)](https://sdk.smartlook.com/ios/smartlook-ios-sdk-1.7.1.3033.zip), unzipping the file and adding `Smartlook.xcframework` to the Xcode project.
