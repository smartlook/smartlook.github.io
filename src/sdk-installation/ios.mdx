...
Smartlook can be also added directly to the app project by **downloading** our latest [Smartlook iOS SDK (1.7.0)](https://sdk.smartlook.com/ios/smartlook-ios-sdk-1.7.0.2975.zip), unzipping the file and adding `Smartlook.xcframework` to the Xcode project.
