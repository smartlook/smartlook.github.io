...
{`
If you experience \"**Found an unexpected Mach-O header code: 0x72613c2**\" error when uploading archived app to App Store, please follow <Link to="/docs/sdk/cookbooks/swift-package-app-store-mach-o-error">this guide</Link>.
`}
</TextBlock>

### 2. Direct integration

Smartlook can be also added directly to the app project by **downloading** our latest [Smartlook iOS SDK (1.7.2)](https://sdk.smartlook.com/ios/smartlook-ios-sdk-1.7.2.3235.zip), unzipping the file and adding `Smartlook.xcframework` to the Xcode project.
...
<TextBlock kind="important">
{`
Please note that due to Cocoapods own limitations, you may not be able to run apps with Smartlook integrated via Cocoapods in simulators on arm64 Macs.
`}
</TextBlock>
