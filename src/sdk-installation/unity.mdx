...
1. Download [Smartlook Android Unity SDK v1.6.0](https://sdk.smartlook.com/android/app-1.6.0-unity.aar).
...
<Code
  ...
  snippets={{
    gradle: `
implementation 'com.smartlook.recording:app:1.6.0-unity-lite'
`,
  }}
/>
