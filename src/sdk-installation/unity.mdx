...
1. Download [Smartlook Android Unity SDK v1.6.1](https://sdk.smartlook.com/android/app-1.6.1-unity.aar).
...
<Code
  ...
  snippets={{
    gradle: `
implementation 'com.smartlook.recording:app:1.6.1-unity-lite'
`,
  }}
/>
