...
\n
### Fixed
- Ocassional crashes caused by \`EXC_BAD_ACCESS KERN_INVALID_ADDRESS\`.
- Safer handling of video pixel buffer pool to avoid \`Fatal Exception: NSInternalInconsistencyException\` crashes with uncertain true cause.
### Changed
