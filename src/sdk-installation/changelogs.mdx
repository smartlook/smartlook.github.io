...
- SDK uses fewer API calls now. One ensuring we use correct configuration and upload ones.
\n
...
/>   
- SDK now uses \`AndroidX\` as default dependencies, but “support” version is still available.
