...
<Code
  ...
  snippets={{
    gradle: `
implementation 'com.smartlook.recording:app:1.5.3-cocos'
`,
  }}
/>
...
Smartlook can be also added directly to the app project by **downloading** the latest [Smartlook iOS SDK](https://sdk.smartlook.com/ios/smartlook-ios-sdk-1.4.1.2356.zip), unzipping the file and adding `Smartlook.framework` to the Xcode project.
