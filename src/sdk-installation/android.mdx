...
<Code
  ...
  snippets={{
    groovy: `
implementation 'com.smartlook.recording:app:1.8.8-native'
`,
  }}
/>
...
<TextBlock kind="note">
{`
Note that \`1.8.8-native\` uses \`AndroidX\` if you need to fallback to \`support\` please use the following:

<Code
  kind="example"
  snippets={{
    groovy: \`
implementation 'com.smartlook.recording:app:1.8.8-native-support'
\`,
  }}
/>
`}
