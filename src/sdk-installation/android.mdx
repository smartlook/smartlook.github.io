...
## 1.8.0 migration
When updating the Smartlook SDK to `1.8.0` (or newer) from older SDK version, some of the SDK imports may be broken. To fix this please follow the [migration guide](/docs/sdk/cookbooks/android_1_8_0_migration).
