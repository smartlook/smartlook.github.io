...
Smartlook.setupAndStartRecording({
  ...
  ionic: {
      typescript: `
smartlook.setup(new SmartlookSetupConfig(
  smartlookAPIkey: "YOUR_API_KEY",
  fps: 2,
  renderingMode: Smartlook.RenderingMode.NATIVE,
  startNewSession: true,
))
smartlook.setupAndStartRecording(new SmartlookSetupConfig(
  smartlookAPIkey: "YOUR_API_KEY",
  fps: 2,
  renderingMode: Smartlook.RenderingMode.NATIVE,
  startNewSessionAndUser: true,
...
<MD visibleOn="android,ionic" markup={`
...
Smartlook.setupAndStartRecording({smartlookAPIKey: string, renderingMode: Smartlook.RenderingMode});
      ...
      ionic: {
       typescript: `
Smartlook.setupAndStartRecording(new SmartlookSetupConfig(smartlookAPIKey: string, fps: number, SmartlookRenderingMode.NATIVE()));
      `,
      },
      ios: {
        swift: `
