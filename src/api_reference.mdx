...
<TextBlock visibleOn="ios,android,cordova,ionic,react,flutter">{`
...
<TextBlock visibleOn="react,flutter">{`
| Parameter              | Required | Description                                                                                                                                        | Default value        |
|------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
| apiKey                 | yes      | Unique 40 character key identifying your app (can be found in the dashboard).                                                                      | ""                   |
| fps                    | no       | Recorded video frame rate (allowed values between 2 and 10). Note that by setting this value you will override frame rate settings from Dashboard! | 2                    |
...
Full SDK setup configuration can be done with \`SmartlookSetupConfigBuilder\`, that provides methods for settting any of the setup parameters shown above.
<CodeBlock
  snippets={{
    ionic: {
      typescript: \`
...
# Rendering
<TextBlock visibleOn="android,ios,cordova,ionic,react,flutter">{`
...
Not all rendering modes are available on this platform.
`}</TextBlock>

| NATIVE | WIREFRAME | NO_RENDERING |
|:--:|:-:|:-:|
|<img src={native_rendering_mode}/> | <img src={wireframe_rendering_mode}/> | <img src={no_rendering_mode}/> |
...
|:--:|:-:|:-:|
|<img src={wireframe_rendering_mode}/> | <img src={blueprint_rendering_mode}/> | <img src={icon_blueprint_rendering_mode}/> |
