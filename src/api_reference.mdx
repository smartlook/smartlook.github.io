...
SDK can be setup later than in Application class, typically when the Application is fetching API key, please take a look [here](/docs/sdk/cookbooks/android-setup-outside-application-class).
`}</TextBlock>
...
\n
Also take a look at [pin code keyboard sample](/docs/sdk/cookbooks/secure-custom-keyboard), demonstrating usage of analytic event modes.
`}</TextBlock>
