...
| startNewSession     | bool                   | false         | Always start new session with Smartlook setup. Full documentation [FIXME here]().  |
| startNewSessionAndUser | bool                | false         | Always start new session and reset user woth Smartlook setup. Full documentation [FIXME here]().  |
`}/>
...
`}/>
<MD visibleOn="ios"  markup={`
Full SDK setup configuration can be done with optional \`setup\` method parameter, e.g.:
`}/>
<CodeBlock
  snippets={{
    android: {
...
Smartlook.setupAndStartRecording(builder.build())
    ...
    ios: {
      swift: `
Smartlook.setup(key: @"YOUR_API_KEY", options:[.enableCrashytics: true, .framerate: 1])
`,
      objc: `
[Smartlook setupWithKey:@"YOUR_API_KEY" options:@{ SLSetupOptionEnableCrashyticsKey : @YES, SLSetupOptionFramerateKey : @1 }];
      `,
    },
  }}
/>
...
`,
      objc: `
BOOL isSmartlookRecording = [Smartlook isRecording];
      `,
    },
  }}
/>
...
Smartlook.setUserIdentifier({identifier: "sample_identifier"})
    ...
    ios: {
      swift: `
 Smartlook.setUserIdentifier("sample_identifier")
`,
      objc: `
[Smartlook setUserIdentifier:@"sample_identifier");
      `,
...
<CodeBlock
  snippets={{
    ios: {
      swift: `
Smartlook.setSessionProperty(value: "value", forName: "property-name")
`,
      objc: `
[Smartlook setSessionPropertyValue:@"value" forName:@"property-name"];
`,
    },
  }}
/>
...
`,
      objc: `
[Smartlook trackCustomEventWithName:(nonnull NSString*)eventName];
      `,
    },
  }}
/>
...
`} />
<MD visibleOn="ios" markup={`
where the \`state\` could flag the event as either \`enter\` or \`exit\` of the navigation controller.
`} />
...
`,
      objc: `
[Smartlook setEventTrackingModeTo:SLEventTrackingModeIgnoreUserInteractionEvents];
SLEventTrackingMode eventTrackingMode = [Smartlook currentEventTrackingMode];
      `,
    },
  }}
/>
