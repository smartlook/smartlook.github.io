...
<Image visibleOn="unreal" src={unreal_enable} width="100%"/>
...
<Image visibleOn="unreal" src={unreal_settings} width="100%"/>
...
Blueprint:
`}</TextBlock>
<Image visibleOn="unreal" src={unreal_bp_startendsession} width="381px"/>
...
<TextBlock visibleOn="ios,react,xamarin">{`
## Blacklisted views
`}</TextBlock>

<TextBlock visibleOn="android">{`
Any view can be hidden in the recording by marking it as a **sensitive** view. A specific view can be marked as sensitive by calling:
`}</TextBlock>
...
<CodeBlock
  snippets={{
    android: {
      java: `
Smartlook.setSensitivty(SmartlookSensitivity.EXPLICITLY_SENSITIVE, View view);
      `,
      kotlin: `
val view: View      
view.isSensitive = SmartlookSensitivity.EXPLICITLY_SENSITIVE
      `,
    },
    ios: {
      swift: `
...
<CodeBlock
  ...
  snippets={{
    android: {
      xml: `
<View>
    <tag android:id="@id/smartlook_sensitive" android:value="true"/>
</View>
      `,
    },
  }}
...
<CodeBlock
  snippets={{
    android: {
      java: `
Smartlook.setSensitivty(SmartlookSensitivity.DEFAULT, View view);
      `,
      kotlin: `
val view: View      
view.isSensitive = SmartlookSensitivity.DEFAULT
      `,
    },
    ios: {
      swift: `
...
<TextBlock kind="note" visibleOn="android">{`
A sensitive view is hidden on recording by a single color rectangle. The color of this rectangle can be configured by calling:
<CodeBlock
  snippets={{
    android: {
      java: \`
...
/>
This is applied for all sensitive objects.
`}</TextBlock>

<TextBlock kind="note" visibleOn="ios,xamarin">{`
...
<TextBlock visibleOn="android">{`
Sometimes it can be beneficial to mark all instances of a given \`Class\` that extends a \`View\` as sensitive rather than blacklisting a specific \`View\` instances:
`}</TextBlock>
...
<CodeBlock
  snippets={{
    android: {
      java: `
Smartlook.setSensitivity(SmartlookSensitivity.EXPLICITLY_SENSITIVE, Class class);
      `,
      kotlin: `
val clazz: Class
clazz.isSensitive = SmartlookSensitivity.EXPLICITLY_SENSITIVE
      `,
    },
    ios: {
      swift: `
...
<TextBlock visibleOn="android">{`
Any sensitive classes can be removed:
`}</TextBlock>
...
<CodeBlock
  snippets={{
    android: {
      java: `
Smartlook.setSensitivity(SmartlookSensitivity.DEFAULT, Class class);
      `,
      kotlin: `
val clazz: Class
clazz.isSensitive = SmartlookSensitivity.DEFAULT
      `,
    },
    ios: {
      swift: `
...
<TextBlock kind="note" visibleOn="android">{`
Note that \`EditText\` and \`WebView\` are **sensitive by default** and can be removed by setting sensitivity to  \`SmartlookSensitivity.DEFAULT\`.
`}</TextBlock>
...
<TextBlock visibleOn="android">{`
A specific view can be insensitive so it is recorded even if it is an instance of a sensitive class:
`}</TextBlock>

<TextBlock visibleOn="ios,xamarin,react">{`
...
<CodeBlock
  snippets={{
    android: {
      java: `
Smartlook.setSensitivty(SmartlookSensitivity.EXPLICITLY_INSENSITIVE, View view);
      `,
      kotlin: `
val view: View      
view.isSensitive = SmartlookSensitivity.EXPLICITLY_INSENSITIVE
      `,
    },
    ios: {
      swift: `
...
<TextBlock visibleOn="android">{`
Or it can be tagged as insensitive directly in an \`xml\` layout file:
`}</TextBlock>
...
<CodeBlock
  ...
  snippets={{
    android: {
      xml: `
<View>
  <tag android:id="@id/smartlook_sensitive" android:value="false"/>
</View>
    `,
    },
    ios: {
...
<TextBlock visibleOn="android">{`
A specific view insensitivity can be removed by calling:
`}</TextBlock>
...
<TextBlock kind="important" invisibleOn="unreal">{`
...
<TextBlock visibleOn="android">{`
When an application has some parts displayed using \`WebView\` and theese parts should be recorded, then the \`WebView\` recording needs to be enabled by removing \`WebView\` from the list of sensitive classes:
`}</TextBlock>
...
<CodeBlock
  ...
  snippets={{
    android: {
      java: `
Smartlook.setSensitivity(SmartlookSensitivity.DEFAULT, WebView.class);
      `,
      kotlin: `
WebView::class.java.isSensitive = SmartlookSensitivity.DEFAULT
      `,
    },
    ios: {
      swift: `
...
Blueprint:
`}</TextBlock>
<Image visibleOn="unreal" source={unreal_bp_setuserid} width="180px"/>
...
Blueprint:
`}</TextBlock>
<Image visibleOn="unreal" src={unreal_bp_recordevent} width="206px"/>
...
<TextBlock kind="note" invisibleOn="unreal">{`
...
<TextBlock invisibleOn="ios,unreal">{`
