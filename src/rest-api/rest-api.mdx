...
# Using the API
Requests to the API are performed using the HTTP protocol to the host `https://public-api.smartlook.com`.
...
# Rate limits
There are thousands of developers making requests to the Smartlook REST API at every moment.
