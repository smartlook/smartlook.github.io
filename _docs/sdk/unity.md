...
1. Download [Smartlook Android Unity SDK v1.2.0](https://sdk.smartlook.com/android/app-1.2.0-unity.aar).
...
```Gradle
implementation('com.smartlook.recording:app:1.2.0-unity-lite')
```
...
1. Download [Smartlook iOS Unity SDK v1.2.3](https://sdk.smartlook.com/ios/smartlook-unity-ios-sdk-1.2.3.zip).
