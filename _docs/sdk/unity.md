...
1. Download [Smartlook Android Unity SDK v1.0.0](https://sdk.smartlook.com/android/app-1.0.0-unity.aar).
...
```Gradle
implementation('com.smartlook.recording:app:1.0.0-unity-lite')
```
